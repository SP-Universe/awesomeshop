...
public class SmallModernLamp2 extends Block {
    ...
    private static final VoxelShape SHAPE_N = Stream.of(Block.makeCuboidShape(4, 0, 4, 12, 1, 12), Block.makeCuboidShape(4.5, 8, 4.5, 11.5, 15, 11.5), Block.makeCuboidShape(7, 0.5, 7, 9, 8.5, 9)).reduce((v1, v2) -> {
        return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();
    private static final VoxelShape SHAPE_W = Stream.of(Block.makeCuboidShape(4, 0, 4, 12, 1, 12), Block.makeCuboidShape(4.5, 8, 4.5, 11.5, 15, 11.5), Block.makeCuboidShape(7, 0.5, 7, 9, 8.5, 9)).reduce((v1, v2) -> {
        return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();
    private static final VoxelShape SHAPE_S = Stream.of(Block.makeCuboidShape(4, 0, 4, 12, 1, 12), Block.makeCuboidShape(4.5, 8, 4.5, 11.5, 15, 11.5), Block.makeCuboidShape(7, 0.5, 7, 9, 8.5, 9)).reduce((v1, v2) -> {
        return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();
    private static final VoxelShape SHAPE_E = Stream.of(Block.makeCuboidShape(4, 0, 4, 12, 1, 12), Block.makeCuboidShape(4.5, 8, 4.5, 11.5, 15, 11.5), Block.makeCuboidShape(7, 0.5, 7, 9, 8.5, 9)).reduce((v1, v2) -> {
        return VoxelShapes.combineAndSimplify(v1, v2, IBooleanFunction.OR);}).get();

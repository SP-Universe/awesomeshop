...
public class RoadSign extends Block {
    ...
    private static final VoxelShape SHAPE_S = Block.makeCuboidShape(2, 2, -6, 14, 14, 4);
    private static final VoxelShape SHAPE_E = Block.makeCuboidShape(-6, 2, 2, 4, 14, 14);

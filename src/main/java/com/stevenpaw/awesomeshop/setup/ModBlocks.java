...
public class ModBlocks {
    public static final RegistryObject<Block> AWESOMNIUM_ORE = register("awesomnium_ore", () ->
            new Block(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance(3, 10).harvestLevel(2).sound(SoundType.STONE)));

    public static final RegistryObject<Block> AWESOMNIUM_BLOCK = register("awesomnium_block", () ->

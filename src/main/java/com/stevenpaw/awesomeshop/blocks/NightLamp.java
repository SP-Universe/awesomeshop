...
public class NightLamp extends Block {
    ...
    //Light Handling
    private static final IntegerProperty LIGHT = IntegerProperty.create("light",0,3); //BooleanProperty if Light is turned on
    ...
    public NightLamp() {
        ...
        this.setDefaultState(this.stateContainer.getBaseState().with(LIGHT, 3));
    }

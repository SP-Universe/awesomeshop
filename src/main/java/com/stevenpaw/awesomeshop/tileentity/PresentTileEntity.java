...
public class PresentTileEntity extends LockableLootTileEntity {
    ...
    public PresentTileEntity(TileEntityType<?> typeIn) {
        super(typeIn);
    }

    public PresentTileEntity() {
        this(ModTileEntityTypes.PRESENT.get());
    }
    ...
    protected ITextComponent getDefaultName() {
        return new TranslationTextComponent("container.present");
    }

    @Override
    protected Container createMenu(int id, PlayerInventory player) {
        return new PresentContainer(id, player, this);
    }
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos pos) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileEntity instanceof PresentTileEntity) {
                return ((PresentTileEntity) tileEntity).numPlayersUsing;
            }
        }
        return 0;
    }

    public static void swapContents(PresentTileEntity te, PresentTileEntity otherTe) {

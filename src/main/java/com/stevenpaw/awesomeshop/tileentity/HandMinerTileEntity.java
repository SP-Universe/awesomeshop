...
public class HandMinerTileEntity extends TileEntity implements ITickableTileEntity {

    public int x, y, z, tick;
    boolean initialized = false;

    public HandMinerTileEntity(final TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public HandMinerTileEntity() {
        this(ModTileEntityTypes.HAND_MINER.get());
    }

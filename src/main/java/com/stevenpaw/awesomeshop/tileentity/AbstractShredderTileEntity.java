...
public abstract class AbstractShredderTileEntity extends LockableTileEntity implements ISidedInventory, IRecipeHolder, IRecipeHelperPopulator, ITickableTileEntity {
    ...
    protected final IIntArray furnaceData = new IIntArray() {
        public int get(int index) {
            switch(index) {
                case 0:
                    return AbstractShredderTileEntity.this.burnTime;
                case 1:
                    return AbstractShredderTileEntity.this.recipesUsed;
                case 2:
                    return AbstractShredderTileEntity.this.cookTime;
                case 3:
                    return AbstractShredderTileEntity.this.cookTimeTotal;
                default:
                    return 0;
            }
        }
        ...
        public void set(int index, int value) {
            switch(index) {
                case 0:
                    AbstractShredderTileEntity.this.burnTime = value;
                    break;
                case 1:
                    AbstractShredderTileEntity.this.recipesUsed = value;
                    break;
                case 2:
                    AbstractShredderTileEntity.this.cookTime = value;
                    break;
                case 3:
                    AbstractShredderTileEntity.this.cookTimeTotal = value;
            }
    ...
    protected final IRecipeType<? extends AbstractShredderRecipe> recipeType;

    protected AbstractShredderTileEntity(TileEntityType<?> tileTypeIn, IRecipeType<? extends AbstractShredderRecipe> recipeTypeIn) {
        super(tileTypeIn);
    ...
    public void tick() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.items.get(0).isEmpty()) {
                IRecipe<?> irecipe = this.world.getRecipeManager().getRecipe((IRecipeType<AbstractShredderRecipe>)this.recipeType, this, this.world).orElse(null);
    ...
    protected int getCookTime() {
        return this.world.getRecipeManager().getRecipe((IRecipeType<AbstractShredderRecipe>)this.recipeType, this, this.world).map(AbstractShredderRecipe::getCookTime).orElse(200);
    }

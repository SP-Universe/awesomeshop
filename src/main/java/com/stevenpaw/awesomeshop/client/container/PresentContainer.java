...
public class PresentContainer extends Container {
    ...
    public final PresentTileEntity tileEntity;
    ...
    public PresentContainer(final int windowId, final PlayerInventory playerInventory, final PresentTileEntity tileEntity) {
        super(ModContainerTypes.PRESENT.get(), windowId);
    ...
    private static PresentTileEntity getTileEntity(final PlayerInventory playerInventory, final PacketBuffer data) {
        Objects.requireNonNull(playerInventory, "playerInventory cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final TileEntity tileAtPos = playerInventory.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof PresentTileEntity) {
            return (PresentTileEntity) tileAtPos;
        }
        throw new IllegalStateException("Tile entity is not correct! " + tileAtPos);
    }

    public PresentContainer(final int windowId, final PlayerInventory playerInventory, final PacketBuffer data) {
        this(windowId, playerInventory, getTileEntity(playerInventory, data));
    }

    @Override
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, BlockInit.PRESENT.get());
    }

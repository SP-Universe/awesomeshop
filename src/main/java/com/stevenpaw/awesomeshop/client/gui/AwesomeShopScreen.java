...
@OnlyIn(Dist.CLIENT)
public class AwesomeShopScreen extends ContainerScreen<AwesomeShopContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(AwesomeShop.MOD_ID, "textures/gui/awesomeshop.png");
    ...
    public AwesomeShopScreen(AwesomeShopContainer containerIn, PlayerInventory playerInv, ITextComponent titleIn) {
    ...
    protected void renderHoveredTooltip(MatrixStack matrixStack, int x, int y) {
        ...
        if (this.hasItemsInInputSlot) {
            ...
            List<AwesomeShopRecipe> list = this.container.getRecipeList();

...
public class PresentScreen extends ContainerScreen<PresentContainer> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(AwesomeShop.MOD_ID, "textures/gui/present.png");

    public PresentScreen(PresentContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {

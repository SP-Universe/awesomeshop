...
public class TrashCanScreen extends ContainerScreen<TrashCanContainer> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(AwesomeShop.MOD_ID, "textures/gui/trashcan.png");

    public TrashCanScreen(TrashCanContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {

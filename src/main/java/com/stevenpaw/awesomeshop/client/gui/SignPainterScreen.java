...
@OnlyIn(Dist.CLIENT)
public class SignPainterScreen extends ContainerScreen<SignPainterContainer> {

    private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(AwesomeShop.MOD_ID, "textures/gui/sign_painter.png");
    ...
    public SignPainterScreen(SignPainterContainer containerIn, PlayerInventory playerInv, ITextComponent titleIn) {
    ...
    protected void renderHoveredTooltip(MatrixStack matrixStack, int x, int y) {
        ...
        if (this.hasItemsInInputSlot) {
            ...
            List<SignPainterRecipe> list = this.container.getRecipeList();

package com.stevenpaw.awesomeshop.util.helpers;
...
public class NBTHelper {
    ...
    public static CompoundNBT toNBT(Object o) {
        ...
        if(o instanceof HandMinerTileEntity) {
            return writeQuarry((HandMinerTileEntity)o);
        }

        return null;
    }

    private static CompoundNBT writeQuarry(HandMinerTileEntity o) {

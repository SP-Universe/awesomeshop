...
public class ShredderContainer extends Container {
    ...
    public ItemStack transferStackInSlot(PlayerEntity player, int sourceSlotIndex)
    {
        ...
        switch (sourceZone) {
            ...
            case PLAYER_MAIN_INVENTORY: // taking out of inventory - find the appropriate furnace zone
                if (!ShredderTileEntity.getSmeltingResultForItem(world, sourceItemStack).isEmpty()) { // smeltable -> add to input
                    successfulTransfer = mergeInto(SlotZone.INPUT_ZONE, sourceItemStack, false);
                }
                if (!successfulTransfer && ShredderTileEntity.getItemBurnTime(world, sourceItemStack) > 0) { //burnable -> add to fuel from the bottom slot first
    ...
    public class SlotFuel extends Slot {
        ...
        public boolean isItemValid(ItemStack stack) {
            return ShredderTileEntity.isItemValidForFuelSlot(stack);
        }
    }
    ...
    public class SlotSmeltableInput extends Slot {
        ...
        @Override
        public boolean isItemValid(ItemStack stack) {
            return ShredderTileEntity.isItemValidForInputSlot(stack);
        }
    }
    ...
    public class SlotOutput extends Slot {
        ...
        @Override
        public boolean isItemValid(ItemStack stack) {
            return ShredderTileEntity.isItemValidForOutputSlot(stack);
        }
    }

...
import com.stevenpaw.awesomeshop.util.FunctionalIntReferenceHolder;
...
public class ShredderContainer extends Container {
    ...
    public ShredderTileEntity tileEntity;
    private IWorldPosCallable canInteractWithCallable;
    public FunctionalIntReferenceHolder shredderTime;

    // Server Constructor
    public ShredderContainer(final int windowID, final PlayerInventory playerInv,
                                   final ShredderTileEntity tile) {
    ...
    // Client Constructor
    public ShredderContainer(final int windowID, final PlayerInventory playerInv, final PacketBuffer data) {
        this(windowID, playerInv, getTileEntity(playerInv, data));
    }

    private static ShredderTileEntity getTileEntity(final PlayerInventory playerInv, final PacketBuffer data) {
        Objects.requireNonNull(playerInv, "playerInv cannot be null");
        Objects.requireNonNull(data, "data cannot be null");
        final TileEntity tileAtPos = playerInv.player.world.getTileEntity(data.readBlockPos());
        if (tileAtPos instanceof ShredderTileEntity) {
            return (ShredderTileEntity) tileAtPos;
        }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(canInteractWithCallable, playerIn, ModBlocks.SHREDDER.get());
    }
